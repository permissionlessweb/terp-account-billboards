...
pub struct CosmwasmAuthenticatorData {
    ...
    #[serde(
        serialize_with = "crate::authenticator::serde::as_base64_encoded_string::serialize",
        deserialize_with = "crate::authenticator::serde::as_base64_encoded_string::deserialize"
    )]
    pub params: Vec<u8>,
}
